...
<!-- Restaurant Content -->
<section class="py-5 text-white text-center" style="background: url('images/freshfood-bg.jpg') center/cover no-repeat;">
    <div class="container">
      <h1 class="display-4 fw-bold">Fresh Food Vendors</h1>
...
?>     
    ...
    <div class="card shadow-sm h-100">
        <img src="admin/uploads/fresh-food/<?php echo $food_image ?>" 
             class="card-img-top" 
          ...
          <div class="card-body py-3">
            <nav aria-label="Page navigation example">
              <ul class="pagination pagination-two justify-content-center">
                ...
                <li class="page-item">
                <a class="page-link" href="abundish?page=<?= $Previous; ?>" aria-label="Previous">
                ...
                <a class='page-link' href='abundish?page={$i}'>{$i}</a></li>";
                }else{
                echo "<li class='page-item'>
                <a class='page-link' href='abundish?page={$i}'>{$i}</a></li>"; 
                }
                ...
                ?>  
                <li class="page-item">
                <a class="page-link" href="abundish?page=<?= $Next; ?>" aria-label="Next">
