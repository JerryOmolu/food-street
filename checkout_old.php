        ...
        <div class="col-lg-8">
              ...
              <div class="col-12 col-md-6">
                <div class="cart-item-card p-3 h-100">
                  <div class="d-flex align-items-center mb-2">
                    <img src="admin/uploads/cooked-food/<?php echo $item['food_image']; ?>" 
                         class="rounded me-3" 
                         style="width:70px; height:70px; object-fit:cover;">
                    <div>
                      <h6 class="mb-1"><?php echo htmlspecialchars($item['food_name']); ?></h6>
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <span class="badge bg-light text-dark">Subtotal: ₦<?php echo number_format($item['price']*$item['quantity'],2); ?></span>
                    <a href="delete_cart.php?cart_id=<?php echo $item['cart_id']; ?>" 
          ...
          <div class="checkout-card p-4">
            ...
            <form action="" method="post">
              <div class="mb-3">
                <textarea name="delivery_address" id="delivery_address" class="form-control" rows="3" placeholder="Enter your delivery address..." required><?php echo isset($_SESSION['delivery_address']) ? htmlspecialchars($_SESSION['delivery_address']) : ''; ?></textarea>
              </div>
        ...
        <div class="col-lg-4">
          <div class="checkout-card p-4 sticky-top" style="top: 90px;">
            ...
            <button type="button" class="btn btn-success w-100 btn-lg mb-2" id="paystackBtn"
              <?php echo empty($_SESSION['delivery_address']) ? 'disabled' : ''; ?>>
